...
function FixedContactButton() {
    ...
    return (
        <div className="fixed bottom-6 left-6">
            <div className={`mt-4 bg-white p-4 text-lg rounded shadow-lg transition-all duration-300 ${showContactInfo ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
